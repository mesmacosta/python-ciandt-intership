...
> Isolate problem in more `classes/functions` could be good path to keep high cohesion and low coupling!

### Source

The Bowling Game Kata at but UncleBob [UncleBob The Bowling Game Kata](http://butunclebob.com/ArticleS.UncleBob.TheBowlingGameKata)
